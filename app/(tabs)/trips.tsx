...
import { cancelTripApi, fetchActiveTripApi, fetchLiveLocationApi } from '@/constants/api';
      ...
      [
        { text: 'Keep Booking', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            const session = getUserSessionSync();
            try {
              const res = await cancelTripApi(targetId, { cancelledBy: 'tourist', role: 'tourist' });
              const socket = getSocket();
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                Alert.alert(
                  ...
                  'Active trips require Admin verification before cancellation.\n\nPlease call Admin Support directly to state your cancellation reason.',
                  [
